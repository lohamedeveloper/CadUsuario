    ...
    <div class="container-xl">
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <p class="loading">Loading Usuários</p>
            </div>
        </div>
    </div>
    <!-- Edit Modal HTML -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-success" value="Cadastrar" onclick="addEmployee()">
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        tr +=
                            '<a href="user/" class="m-1 edit" data-toggle="modal"</a>';
                        tr +=
